	Algoritmo Rombo2
		...
		Escribir "Dime una altura para tu rombo" ;
		Leer altura ;
		
		Escribir "Dime que con que caracter quieres pintar tu rombo" ;
		Leer simbolo ;
		...
		Para altura <- 2 Hasta altura  Con Paso 1 Hacer //bucle que nos hace variar las filas 
